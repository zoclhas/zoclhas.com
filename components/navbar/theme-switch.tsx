    ...
    return (
        <div className="relative">
            <motion.button
                ...
                style={{
                    background: themes.filter((e) => e.color === theme)[0].prim,
                    borderColor: themes.filter((e) => e.color === theme)[0].hex,
                }}
            ...
            <motion.ul
                className="w-[200px] p-2 absolute right-1 mt-4 bg-white/10 rounded-2xl backdrop-blur-lg flex flex-col gap-2"
                variants={variants}
                initial={{
                    translateY: 30,
                    opacity: 0,
                ...
                {themes.map((th, i) => (
                    ...
                    >
                        <div
                            ...
                            style={{ background: th.prim, borderColor: th.hex }}
                        ></div>
                        <span>{th.color}</span>
                    </motion.li>
                ))}
